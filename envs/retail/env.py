...
FOLDER_PATH = Path(__file__).parent.parent.parent / "retail" / "data"
...
class MockRetailDomainEnv(Env):
    def __init__(
        ...
        match task_split:
            case "test":
                from .tasks_test import TASKS_TEST as tasks
            case "train":
                from .tasks_train import TASKS_TRAIN as tasks
            case "dev":
                from .tasks_dev import TASKS_DEV as tasks
            case _:
