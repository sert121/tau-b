"""
Search one-stop flight tool for inspect_ai - converts tau-bench search_onestop_flight tool
"""
...
def search_onestop_flight(origin: str, destination: str, date: str, flights_data: Dict[str, Any]) -> str:
    ...
    Returns:
        JSON string containing available one-stop flight combinations.
    """
...
def get_search_onestop_flight_tool_info() -> Dict[str, Any]:
